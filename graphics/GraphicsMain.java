       ...
       public void drawCombatBar() {
              ...
              if (inCombat) {
                     ...
                     if (weapon2.collide(player1) == true && player1.getHealth() > 0) {
                           ...
                           // rect(30 + 300 * ((player1.getHealth()) /

                           // player1.getOriginalHealth()),

                           // height - 140, 300 * (player1.getOriginalHealth() -

                           // player1.getHealth() / player1.getOriginalHealth()), 40);
                     ...
                     if (weapon1.collide(player2) == true && player2.getHealth() > 0) {
                           ...
                           // 300 * (player2.getOriginalHealth() - player2.getHealth() /

                           // player2.getOriginalHealth()), 40);
